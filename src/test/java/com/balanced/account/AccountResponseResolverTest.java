package com.balanced.account;

import com.balanced.account.dto.AccountResponse;
import com.balanced.account.resolver.AccountResolver;
...
class AccountResponseResolverTest {
    ...
    private com.balanced.account.entity.Account buildAccount(String name) {
        return com.balanced.account.entity.Account.builder()
                .id(accountId)
    ...
    void updateAccount_delegatesToService() {
        ...
        com.balanced.account.entity.Account updated = buildAccount("Updated");
